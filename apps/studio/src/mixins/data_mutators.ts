...
export default {
  ...
  methods: {
    ...
    /**
     * "3 days ago" for a date/time cell, so the distance from now is readable
     * without doing the arithmetic. Returns null for anything else, including
     * dates we can't parse.
     */
